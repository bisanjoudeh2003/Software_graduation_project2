...
class _PortfolioViewScreenState extends State<PortfolioViewScreen>
  ...
  Future<void> _loadPortfolio() async {
    try {
      final token = await AuthService.getToken();
      final res1  = await http.get(Uri.parse("$baseUrl/portfolio/me"),
          headers: {"Authorization": "Bearer $token"});
      if (res1.statusCode != 200) return;
      final pId  = jsonDecode(res1.body)["id"];
      final res2 = await http.get(Uri.parse("$baseUrl/portfolio/full/$pId"),
          headers: {"Authorization": "Bearer $token"});
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text("Loading...",
            style: TextStyle(color: _grey, fontSize: 12,
                fontFamily: 'Playfair', letterSpacing: 1.5)),
      ]),
    ),
  );
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: _green.withOpacity(0.12),
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    if (specialties.isNotEmpty) ...[
                      const SizedBox(height: 4),
                      Text(specialties,
                          style: const TextStyle(color: _greenSoft, fontSize: 12,
  ...
  Widget _buildEditButtons() => Padding(
    ...
    child: Row(children: [
      Expanded(child: _editBtn("Edit Profile",
          Icons.person_outline_rounded, true, _goEditProfile)),
      const SizedBox(width: 10),
      Expanded(child: _editBtn("Edit Works",
          Icons.photo_library_outlined, false, _goEditWorks)),
    ]),
  );
  ...
  Widget _statItem(String val, String label, IconData icon, Color color) =>
      Column(children: [
        ...
        const SizedBox(height: 4),
        Text(val, style: TextStyle(color: color, fontSize: 16,
            fontWeight: FontWeight.bold, fontFamily: 'Playfair')),
        Text(label, style: const TextStyle(color: _grey, fontSize: 9,
            fontFamily: 'Playfair', letterSpacing: 0.4)),
      ]);
    ...
    return Container(
      ...
      child: Row(
        children: List.generate(tabs.length, (i) {
          ...
          return Expanded(
            child: GestureDetector(
              onTap: () => setState(() { _activeTab = i; _selectedCategoryId = null; }),
  ...
  Widget _buildAllTab() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (albums.isNotEmpty) ...[
        _sectionTitleWithAction("Albums", Icons.photo_album_outlined,
  ...
  Widget _buildPhotosTab() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      if (categories.isNotEmpty) ...[
        _sectionTitle("Category", Icons.label_outline, _grey),
        _buildCategoryChips(), const SizedBox(height: 8),
      ],
      photos.isEmpty ? _buildEmptyState(label: "No photos yet")
  ...
  Widget _buildVideosTab() {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      vids.isEmpty ? _buildEmptyState(label: "No videos yet")
  ...
  Widget _buildFeaturedMasonry() {
    ...
    return Padding(
      ...
      child: Column(children: [
        GestureDetector(onTap: () => _openMedia(featured[0]),
            child: _bigFeaturedCard(featured[0])),
        if (featured.length > 1) ...[
          const SizedBox(height: 8),
          Row(children: [
            Expanded(child: GestureDetector(onTap: () => _openMedia(featured[1]),
  ...
  Widget _bigFeaturedCard(Map item) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: _gold.withOpacity(0.08),
      ...
      child: ClipRRect(
        ...
        child: Stack(fit: StackFit.expand, children: [
          isVideo
              ? Container(color: _green.withOpacity(0.08),
                  child: Center(child: Icon(Icons.play_circle_fill,
                      size: 60, color: _green.withOpacity(0.4))))
              : url.isNotEmpty
          ...
          Container(decoration: const BoxDecoration(gradient: LinearGradient(
            ...
            colors: [Colors.transparent, Color(0xCC000000)], stops: [0.4, 1.0]))),
          Positioned(top: 12, left: 12,
              child: _badge(isVideo ? Icons.play_arrow_rounded : Icons.star_rounded,
      ...
      child: ClipRRect(
        ...
        child: Stack(fit: StackFit.expand, children: [
          ...
          Positioned(top: 8, left: 8,
              child: _badge(isVideo ? Icons.videocam : Icons.star_rounded,
                  isVideo ? "Video" : "★", small: true)),
        ]),
      ),
    );
  }
        ...
        itemBuilder: (_, i) {
          ...
          return GestureDetector(
            ...
            child: ClipRRect(
              ...
              child: Stack(fit: StackFit.expand, children: [
                isVideo
                    ? Container(color: _green.withOpacity(0.1),
                        child: Center(child: Icon(Icons.play_circle_fill,
                            size: 28, color: _greenSoft)))
                    : url.isNotEmpty
                        ? Image.network(url, fit: BoxFit.cover,
                            errorBuilder: (_, __, ___) => _placeholder())
                        : _placeholder(),
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Stack(fit: StackFit.expand, children: [
                  ...
                  Center(child: Icon(Icons.play_circle_fill,
                      size: 48, color: _green.withOpacity(0.35))),
                  Container(decoration: const BoxDecoration(gradient: LinearGradient(
                    begin: Alignment.topCenter, end: Alignment.bottomCenter,
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: Stack(fit: StackFit.expand, children: [
                ...
                Container(decoration: const BoxDecoration(gradient: LinearGradient(
                  begin: Alignment.topCenter, end: Alignment.bottomCenter,
                  colors: [Colors.transparent, Color(0xDD000000)], stops: [0.35, 1.0]))),
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: Stack(fit: StackFit.expand, children: [
                ...
                Container(decoration: const BoxDecoration(gradient: LinearGradient(
                  begin: Alignment.topCenter, end: Alignment.bottomCenter,
                  colors: [Colors.transparent, Color(0xEE000000)], stops: [0.3, 1.0]))),
              ...
              child: Container(
                ...
                child: _error
                    ? const Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        SizedBox(height: 10),
                        Text("Failed to load video", style: TextStyle(color: Colors.white38,
                            fontSize: 13, fontFamily: 'Playfair'))]))
                    : !_initialized
                ...
                child: ValueListenableBuilder(
                  ...
                  builder: (_, VideoPlayerValue val, __) {
                    ...
                    return LinearProgressIndicator(
                      ...
                      valueColor: const AlwaysStoppedAnimation(_greenSoft),
                      minHeight: 2,
                    );
                  },
                ),
