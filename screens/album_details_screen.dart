...
class _AlbumDetailsScreenState extends State<AlbumDetailsScreen>
  ...
  Color get _mutedSurface =>
      _isDark ? Colors.white.withOpacity(0.04) : Colors.grey.shade100;
  Color get _sheetColor => _cardColor;
  Color get _borderColor =>
      _isDark ? Colors.white12 : _primary.withOpacity(0.13);
  Color get _lightBorder =>
      _isDark ? Colors.white10 : _primary.withOpacity(0.15);
  ...
  Widget _editField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: _theme.inputDecorationTheme.fillColor ?? _softSurface,
        contentPadding:
...
class _VideoPlayerDialogState extends State<_VideoPlayerDialog> {
  ...
  ColorScheme get _scheme => _theme.colorScheme;
  bool get _isDark => _theme.brightness == Brightness.dark;
  Color get _sheetColor => _theme.cardColor;
  Color get _primary => _scheme.primary;
  Color get _textColor =>
      _theme.textTheme.bodyLarge?.color ??
      (_isDark ? Colors.white : Colors.black87);
              ...
              ValueListenableBuilder(
                ...
                builder: (_, VideoPlayerValue val, __) {
                  ...
                  return LinearProgressIndicator(
                    value: progress,
                    backgroundColor: _isDark ? Colors.white12 : Colors.grey[300],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 14),
                  Divider(color: _isDark ? Colors.white12 : const Color(0xFFDDE8E4)),
                    ...
                    children: [
                      Expanded(
                        child: _btn(
                          ...
                          label: "Edit",
                          color: _primary,
                          bg: _isDark ? Colors.white.withOpacity(0.06) : _primary.withOpacity(0.08),
                          onTap: () {
                            Navigator.pop(context);
                            widget.onEdit();
                          },
