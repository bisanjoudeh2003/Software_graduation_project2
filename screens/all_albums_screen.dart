...
class AllAlbumsScreen extends StatelessWidget {
  ...
  Color _softBorder(BuildContext context) =>
      _isDark(context) ? Colors.white12 : primaryGreen.withOpacity(0.13);

  Color _placeholderBg(BuildContext context) =>
      _isDark(context) ? Colors.white.withOpacity(0.06) : const Color(0xFFE8EDE9);
                      ...
                      (context, i) {
                        ...
                        return TweenAnimationBuilder<double>(
                          ...
                          child: GestureDetector(
                            ...
                            child: _albumCard(context, album),
                          ),
                        );
                      },
  ...
  Widget _albumCard(BuildContext context, Map album) {
    final String title = (album["title"] ?? "").toString();
    final int count =
        int.tryParse((album["items_count"] ?? "0").toString()) ?? 0;
