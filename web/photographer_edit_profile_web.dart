...
class PhotographerEditProfileWeb extends StatefulWidget {
  final Map<String, dynamic>? currentData;
  final String? profileImageUrl;
  final String fullName;
  final String phone;

  const PhotographerEditProfileWeb({
    super.key,
    this.currentData,
  ...
  @override
  State<PhotographerEditProfileWeb> createState() =>
      _PhotographerEditProfileWebState();
}

class _PhotographerEditProfileWebState
    extends State<PhotographerEditProfileWeb> {
  ...
  Future<void> _pickLocationOnMap() async {
    ...
    if (result != null) {
      setState(() {
        _selectedLatitude = result["latitude"] ?? result["lat"];
        _selectedLongitude = result["longitude"] ?? result["lng"];
