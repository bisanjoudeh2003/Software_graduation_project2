...
class _PhotographerProfilePageState extends State<PhotographerProfilePage> {
  ...
  Future<void> openEditProfile() async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => PhotographerEditProfileScreen(
          ...
          phone:           user["phone"]?.toString() ?? "",  // ← التعديل: إرسال الفون
        ),
      ),
    );
    ...
    if (result != null && result["updated"] == true) {
      setState(() {
        ...
        if (result["phone"] != null)           // ← التعديل: تحديث الفون
                          ...
                          children: [
                            ...
                            if (photographerData.isNotEmpty) ...[
                              ...
                              Row(
                                ...
                                children: [
                                  _statBadge("$expYears yrs", "Experience",
                                      Icons.timer_outlined),
                                  const SizedBox(width: 12),
                                  _statBadge("\$$priceHr/hr", "Rate",
                      ...
                      children: [
                        ...
                        _card([
                          _menuItem(Icons.edit_outlined, "Edit Profile",
                              "Update your info", primaryGreen, openEditProfile),
                          _divider(),
                          _menuItem(
  ...
  Widget _divider() => Divider(
      height: 1, indent: 56, endIndent: 20, color: Colors.grey.shade100);
