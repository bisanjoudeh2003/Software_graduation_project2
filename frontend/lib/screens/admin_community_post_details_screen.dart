...
class AdminCommunityPostDetailsScreen extends StatefulWidget {
  final int postId;

  const AdminCommunityPostDetailsScreen({
    super.key,
    required this.postId,
  });

  @override
  State<AdminCommunityPostDetailsScreen> createState() =>
      _AdminCommunityPostDetailsScreenState();
}

class _AdminCommunityPostDetailsScreenState
    extends State<AdminCommunityPostDetailsScreen> {
  bool loading = true;
  ...
  Color get _statusColor {
    if (_hidden) return adminGrey;
    if (_reports.isNotEmpty) return adminRed;
    if (_status == "approved") return adminSoftGreen;
    if (_status == "rejected") return adminRed;
    return adminGold;
  }
  ...
  Future<void> _togglePostVisibility() async {
    ...
    final confirm = await _confirmDialog(
      ...
      confirmColor: nextHidden ? adminGold : adminSoftGreen,
      icon: nextHidden
  ...
  Widget _header(Map<String, dynamic> p) {
    ...
    return Stack(
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                Colors.black.withOpacity(bgImage.isNotEmpty ? 0.62 : 0.10),
                adminPrimaryGreen.withOpacity(0.95),
              ],
        ...
        SafeArea(
          child: Padding(
            padding: const EdgeInsets.fromLTRB(20, 42, 20, 46),
            child: Column(
    ...
    return _section(
      ...
      children: [
        ...
        if (rejectionReason.isNotEmpty) ...[
          ...
          _reasonBox("Rejection reason", rejectionReason, adminRed),
        ],
      ],
    );
  }
          ...
          children: [
            ...
            Expanded(
              child: _metricBox(
                ...
                _reports.isEmpty ? adminGrey : adminRed,
              ),
            ),
          ],
        ),
  ...
  Widget _commentItem({
    ...
    final color = hidden ? adminGrey : adminPrimaryGreen;
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: hidden
                    ? adminSoftGreen.withOpacity(0.10)
                    : adminGold.withOpacity(0.10),
              ...
              child: Icon(
                hidden
                    ? Icons.visibility_outlined
                    : Icons.visibility_off_outlined,
                color: hidden ? adminSoftGreen : adminGold,
                size: 17,
              ),
            ),
          ),
    ...
    return _section(
      ...
      children: [
        ...
        _actionRow(
          ...
          color: _hidden ? adminSoftGreen : adminGold,
  ...
  Widget _emptyInline(String text) {
    return Container(
      ...
      padding: const EdgeInsets.all(13),
      decoration: BoxDecoration(
        color: adminLightCream.withOpacity(0.6),
        borderRadius: BorderRadius.circular(16),
      ),
      child: Text(
        text,
